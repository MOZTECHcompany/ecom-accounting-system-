...
1. 為特休新增年資級距規則
2. 把薪資單下載改成真正 PDF 產出，而不是目前的列印版
3. 補假別/額度/薪資批次操作的 audit log
4. 把 `paid` 後續流程接到真正銀行出款 / 對帳 / 匯款憑證管理
5. 規劃更細的薪資規則項目，例如公司負擔、扣繳與多階段加班倍率
...
- 個人薪資單目前走瀏覽器列印流程，還不是真正的伺服器 PDF 檔案
...
9. 再補真正 PDF 薪資單、銀行出款對帳與更細的主管審核模型
